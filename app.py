...
class App:
    ...
    def _create_stack(self, num_panels, panel_spacing, panel_width, boat_length):
    ...
    def setup_callbacks(self):
        ...
        def update_plot(num, spacing, width, boat_len, heading, azimuth):
            ctx = dash.callback_context
            
            trigger = ctx.triggered[0]['prop_id']
            if 'num-panels-input' in trigger or 'panel-spacing-input' in trigger or 'panel-width-input' in trigger or 'boat-length-input' in trigger:
